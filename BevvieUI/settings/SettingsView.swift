...
//
//  settings view contains buttons for various actions, shows user profile card
...
struct SettingsView: View {
    ...
    var body: some View {
        ZStack {
            ...
            // present appropriate view based on button click
            if privacyPresent {
...
struct SettingsView_Previews: PreviewProvider {
    static var previews: some View {
        SettingsView(settingsPresent: .constant(false), isLoggedIn: .constant(true), isSignedUp: .constant(true))
